...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Db</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-db_home_id">
                                        <th class="title"> Db Home Id: </th>
                                        <td class="value"> <?php echo $data['db_home_id']; ?></td>
                                    </tr>
                                    <tr  class="td-db_name">
                                        <th class="title"> Db Name: </th>
                                        <td class="value"> <?php echo $data['db_name']; ?></td>
                                    </tr>
                                    <tr  class="td-db_unique_name">
                                        <th class="title"> Db Unique Name: </th>
                                        <td class="value"> <?php echo $data['db_unique_name']; ?></td>
                                    </tr>
                                    <tr  class="td-id">
                                        <th class="title"> Id: </th>
                                        <td class="value"> <?php echo $data['id']; ?></td>
                                    </tr>
                                    <tr  class="td-pdb_name">
                                        <th class="title"> Pdb Name: </th>
                                        <td class="value"> <?php echo $data['pdb_name']; ?></td>
                                    </tr>
