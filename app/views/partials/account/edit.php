                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <label class="control-label" for="report_receiver">Report Receiver <span class="text-danger">*</span></label>
                                                        </div>
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <?php
                                                                $report_receiver_options = Menu :: $report_receiver;
                                                                $field_value = $data['report_receiver'];
                                                                if(!empty($report_receiver_options)){
                                                                foreach($report_receiver_options as $option){
                                                                $value = $option['value'];
                                                                $label = $option['label'];
                                                                ...
                                                                <label class="custom-control custom-radio custom-control-inline">
                                                                    <input id="ctrl-report_receiver" class="custom-control-input" <?php echo $checked ?>  value="<?php echo $value ?>" type="radio" required=""   name="report_receiver" />
