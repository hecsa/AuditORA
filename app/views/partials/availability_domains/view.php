...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Availability Domains</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-compartment_id">
                                        <th class="title"> Tenancy Id: </th>
                                        <td class="value"> <?php echo $data['compartment_id']; ?></td>
                                    </tr>
                                    <tr  class="td-id">
                                        <th class="title"> Availability-Domain Id: </th>
                                        <td class="value"> <?php echo $data['id']; ?></td>
                                    </tr>
                                    <tr  class="td-name">
                                        <th class="title"> Availability-Domain Name: </th>
