...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Compute Block Volumes</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-block_volume_id">
                                        ...
                                        <td class="value"> <?php echo $data['block_volume_id']; ?></td>
                                    </tr>
                                    ...
                                    <tr  class="td-size_in_gbs">
                                        <th class="title"> Size In Gbs: </th>
                                        <td class="value"> <?php echo $data['size_in_gbs']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
