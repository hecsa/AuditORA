                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-report_receiver"  value="<?php  echo $this->set_field_value('report_receiver',"0"); ?>" type="number" placeholder="Enter Report Receiver" step="1"  required="" name="report_receiver"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
