...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Compute</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-compartments_name">
                                        <th class="title"> Compartment Name: </th>
                                        <td class="value"> <?php echo $data['compartments_name']; ?></td>
                                    </tr>
                                    <tr  class="td-compid">
                                        <th class="title"> Compartment Id: </th>
                                        <td class="value"> <?php echo $data['compid']; ?></td>
                                    </tr>
                                    ...
                                    <tr  class="td-adname">
                                        ...
                                        <td class="value"> <?php echo $data['adname']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
