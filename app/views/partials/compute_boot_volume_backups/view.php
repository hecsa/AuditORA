...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Compute Boot Volume Backups</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-source_type">
                                        ...
                                        <td class="value"> <?php echo $data['source_type']; ?></td>
                                    </tr>
                                    <tr  class="td-time_request_received">
                                        <th class="title"> Time Request Received: </th>
                                        <td class="value"> <?php echo $data['time_request_received']; ?></td>
                                    </tr>
                                    ...
                                    <tr  class="td-unique_size_in_gbs">
                                        ...
                                        <td class="value"> <?php echo $data['unique_size_in_gbs']; ?></td>
                                    </tr>
