<?php
define("DEFAULT_TIMEZONE", "America/Argentina/Buenos_Aires"); // set php date functions timezone
...
define("APP_ID", "4782e3c000c727818e8e150382123cbb");
...
define("DB_USERNAME", "auditora");
define("DB_PASSWORD", "4Ud1t0r4");
define("DB_NAME", "auditora");
...
define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['rowid'] : null ));
